...
We have written the model in two alternative forms because the first form makes the analogy with the continuous-time logistic model more obvious, while the second form makes it easier to read off the fixed point. @eq-verhulst is also often referred to as the logistic map and is a famous example of a chaotic system.
