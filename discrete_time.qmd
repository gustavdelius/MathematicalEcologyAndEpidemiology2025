...
$$
N^* = \frac{b\,{N^*}^2}{1+{N^*}^2}.
$$ {#eq-discrete-harvesting_fixed_points}
...
$$
1+{N^*}^2 = bN^*.
$$ {#eq-discrete-harvesting_fixed_points_nonzero}
This is a quadratic equation for $N^*$, which we could rewrite in the more conventional form
$$
{N^*}^2 - bN^* + 1 = 0.
$$ {#eq-discrete-harvesting_fixed_points_nonzero_quadratic}
The solutions to this equation are
$$
N^*_\pm = \frac{b\pm\sqrt{b^2-4}}{2}.
$$ {#eq-discrete-harvesting_fixed_points_nonzero_quadratic_solution}
...
$$ {#eq-discrete-harvesting_fixed_points_harvesting}
...
$$
(1+E){N^*}^2-bN^*+1+E = 0.
$$ {#eq-discrete-harvesting_fixed_points_harvesting_nonzero}
This is solved by
$$
N^*_\pm = \frac{\frac{b}{1+E}\pm\sqrt{\left(\frac{b}{1+E}\right)^2-4}}{2}.
$$ {#eq-discrete-harvesting_fixed_points_harvesting_nonzero_solution}
...
::: {#exr-1.1}
#### Period-doubling and transcritical bifurcations
...
transcritical bifurcation at $r=1$. 
:::
