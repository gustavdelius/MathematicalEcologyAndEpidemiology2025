...
There can be several causes for an Allee effect. For example as the population number increases, the individuals are able to shelter each other better against the wind or against predators. Or it becomes easier for them to find compatible mates. But even in the case of an Allee effect, eventually the population growth has to slow again as the population reaches the carrying capacity of the ecosystem.
