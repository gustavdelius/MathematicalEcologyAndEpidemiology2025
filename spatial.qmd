...
$b^4D_1^2-6D_1D_2b^2+D_2^2>0$. We can rewrite this in terms of the ratio $d=D_2/D_1$ as
$$
b^4-6db^2+d^2>0.
$$ {#eq-schnakcond}
...
$$ {#eq-schnakcond2}
This means that the inhibitor must diffuse at least $b^2(3+\sqrt{8})$ times faster than the activator in order for a Turing instability to occur.
...
u(x,t)=A(z),~~~v(x,t)=B(z)
$$ {#eq-sirlogistic5}
with $z=x-ct$ for some wave speed $c$
